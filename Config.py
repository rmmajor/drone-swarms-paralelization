...
SIMULATIONS_CHECKPOINT = (
    100  # Number of episodes that must happen before printing checkpoint
)
...
MAXIMUM_WAIT_HOURS = 0.5  # wtf?
COMPLETENESS_COVERAGE = 1.0  # float between 0 and 1  # wtf?
MAXIMUM_UNCHANGED_ENVIRONMENT_EPISODES = 9999999999  # wtf?
